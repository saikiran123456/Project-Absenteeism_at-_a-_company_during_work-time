...
# create the special class to use to predict new data
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            # to preserve the code we've created in the previous section, I will add a column with 'NaN' strings
            ...
            # dropping the 'Date' column from df
            ...
            # Including this line of code if we want to call the 'preprocessed data'
